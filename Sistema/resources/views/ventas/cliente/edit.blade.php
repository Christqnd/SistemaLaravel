...
<div class="row">
	...
	<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
		<div class="form-group">
			<button class="btn  btn-primary" type="submit" title="Guarda y vuelve a listar">Guardar</button>
			<button class="btn  btn-danger" type="reset"><a href="{{URL::action('ClienteController@index')}}" title="Cancelar y volver atrás" style=" color:white">Cancelar</a></button>
		</div>
	</div>
</div>
